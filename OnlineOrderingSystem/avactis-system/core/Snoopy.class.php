...
class Snoopy
{
	...
	var $_fp_timeout	=	3;					// timeout for socket connection
	...
	function _httprequest($url,$fp,$URI,$http_method,$content_type="",$body="")
	{
		...
		if(!empty($this->cookies))
		{
			...
			if ( count($this->cookies) > 0 ) {
				...
				$headers .= _byte_substr($cookie_headers,0,-2) . "\r\n";
			}
		}
		...
		fwrite($fp,$headers.$body,_byte_strlen($headers.$body));
