...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('SYS','MNG_CNTR_PAGE_TITLE');
		$tpl_header = getxMsg('SYS','MNG_CNTR_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
					...
					array(
						'name' => getxMsg('SYS','MNG_CNTR_PAGE_TITLE'),
						'url' => ''
				));
		$tpl_help = 'location_countries';
		$tpl_class = 'CountriesSettings';
