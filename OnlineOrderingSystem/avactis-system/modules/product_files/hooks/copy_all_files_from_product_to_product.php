...
class CopyAllFilesFromProductToProduct
{
    function CopyAllFilesFromProductToProduct()
    {
    }
    ...
    function onHook($actionObj)
    {
        ...
        if(!empty($copy_results))
        {
            ...
            {
                modApiFunc("Product_Files","copyAllFilesFromProductToProduct",$old_pid,$new_pid);
            };
        };
    }
};
