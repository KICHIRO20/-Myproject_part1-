...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('MNF', 'MNF_ADD_PAGE_TITLE');
		$tpl_header = getxMsg('MNF', 'MNF_ADD_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
						array(
							...
							array(
									'name' => getxmsg('MNF', 'MNF_ADD_PAGE_TITLE'),
									'url' => ''
							)
						);
		$tpl_help = 'mnf_add_manufacturer';
		$tpl_class = 'Add_Manufucture_Fun';
//		$tpl_scripts = array('admin-layout','admin-avactis-main','admin-avactis-validate');
	include('admin.tpl.php');
?>

<?php
	function Add_Manufucture_Fun(){
		AddManufacturer();
