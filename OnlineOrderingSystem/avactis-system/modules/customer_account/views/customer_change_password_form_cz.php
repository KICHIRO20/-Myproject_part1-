...
class CustomerChangePasswordForm
{
    function getTemplateFormat()
    {
        $format = array(
            'layout-file'        => 'customer-account-change-password-form.ini'
           ,'files' => array(
    ...
    function output()
    {
        ...
        $this->template = $application->getBlockTemplate('CustomerChangePasswordForm');
