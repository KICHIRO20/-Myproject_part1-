...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('SYS','PRD_ADD_PAGE_TITLE');
		$tpl_header = getxMsg('SYS','PRD_ADD_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
				...
				array(
						'name' => getxmsg('SYS','PRD_ADD_PAGE_TITLE'),
						'url' => ''
				)
				);
		$tpl_help = 'catalog_add_product';
		$tpl_class = 'AddProductInfo';
		$tpl_tinymce = 'yes';
