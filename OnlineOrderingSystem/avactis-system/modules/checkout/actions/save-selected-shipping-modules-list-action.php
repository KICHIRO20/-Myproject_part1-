...
/**
 * Checkout module.
 * Action handler on SaveSelectedShippingModulesList.
 *
 * @package Checkout
 * @access  public
 */
class SaveSelectedShippingModulesList extends AjaxAction
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
     ...
     */
    function SaveSelectedShippingModulesList()
    {
    }
	...
	$NewSelectedModules = array_intersect($selected_array,$NewSelectedModules);
        //"All Inactive" Shipping Module should be always selected to appear in CZ.
        ...
        //$res = modApiFunc('Checkout', 'updateAllInactiveModuleStatus', 'shipping');

        modApiFunc('Session','set','ResultMessage','SHIP_METH_SAVED_MSG');
        $request = new Request();
