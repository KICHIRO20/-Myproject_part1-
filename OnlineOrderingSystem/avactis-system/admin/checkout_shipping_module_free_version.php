...
<HTML>
<HEAD>
<TITLE><?php msg('SHIP_MODULE_SETTINGS_PAGE_TITLE'); ?></TITLE>
...
<!--    <colgroup>
    ...
    <tr class="title">
        <td class="title popup_dialog_header_left_right_padded" colspan="3">Shipping Module: <?php isset($_GET['sm_name']) ? print $_GET['sm_name'] : print 'Module'; ?></td>
    </tr>
    <tr class="subtitle" style="height: 25px;">
        <td class="popup_dialog_header_left_right_padded" colspan="3" style="padding: 0px 0px 0px 4px;">
            <table class="clear" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="80%"><?php isset($_GET['sm_name']) ? print $_GET['sm_name'] : print 'Module'; ?> Details</td>
                </tr>
            </table>
        </td>
    </tr>
