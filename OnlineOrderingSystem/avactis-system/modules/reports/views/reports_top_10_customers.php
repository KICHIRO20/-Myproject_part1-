...
class ReportTopTenCustomerStatistics extends CReportView
{
    function ReportTopTenCustomerStatistics()
    {
        parent::CReportView();
        $this->__render_class_name = 'CReportRenderFlatTable';
        $this->__source_class_name = 'CTopTenCustomerStatistics';
...
//                       modApiFunc("Localization", "SQL_time_format", $row['visit_previous_time']).
    ...
    function __colorizeValue($value, $flag, $style="font-weight: bold;")
    {
        if ($flag === true)
        {
...
class ReportRecentVisitorStatisticsShort extends ReportTopTenCustomerStatistics
{
    function ReportRecentVisitorStatisticsShort()
    {
        parent::ReportTopTenCustomerStatistics();
    }
