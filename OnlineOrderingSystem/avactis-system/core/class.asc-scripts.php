 ...
 *
 * These classes were refactored from the WordPress ASC_Scripts and WordPress
 * script enqueue API.
 *
 * @package BackPress
 * @since r16
 ...
 *
 * @package BackPress
 * @uses ASC_Dependencies
 * @since r16
 */
class ASC_Scripts extends ASC_Dependencies {
	...
	function init() {
		/**
		 * Fires when the ASC_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param ASC_Scripts &$this ASC_Scripts instance, passed by reference.
		 */
		do_action_ref_array( 'asc_default_scripts', array(&$this) );
	}
