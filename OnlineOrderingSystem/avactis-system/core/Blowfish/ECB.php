 ...
 * @version    CVS: $Id: ECB.php,v 1.6 2006/05/29 17:16:43 jausions Exp $
...
class Crypt_Blowfish_ECB extends Crypt_Blowfish_PHP
{
    ...
    function encrypt($plainText)
    {
        ...
        $cipherText = '';
        $len = _byte_strlen($plainText);
        $plainText .= str_repeat(_byte_chr(0), (8 - ($len % 8)) % 8);

        for ($i = 0; $i < $len; $i += 8) {
            list(, $Xl, $Xr) = unpack('N2', _byte_substr($plainText, $i, 8));
