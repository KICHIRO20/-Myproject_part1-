...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('SYS','EDIT_TAX_DISPLAY_OPTION_PAGE_TITLE');
		$tpl_header = getxMsg('SYS','EDIT_TAX_DISPLAY_OPTION_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
					...
					array(
						'name' => getxmsg('SYS','EDIT_TAX_DISPLAY_OPTION_PAGE_TITLE'),
						'url' => ''
				));
		$tpl_help = 'store_settings_taxes_add_edit_display';
		$tpl_class = 'EditTaxDisplayOption';
