...
loadCoreFile('Blowfish/DefaultKey.php');

loadCoreFile('Blowfish/PHP.php');

loadCoreFile('Blowfish/MCrypt.php');

loadCoreFile('Blowfish/ECB.php');
...
//                include_once 'Crypt/Blowfish/MCrypt.php';
    ...
    {
        $result = base64_encode($this->_crypt->encrypt($plainText));
        return $result;
    }
