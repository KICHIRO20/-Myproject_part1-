...
/**
 * Checkout Customer-Info-Input view.
 *
 * @package Checkout
 * @author Vadim Lyalikov
 */
class CheckoutCustomerInfoInput extends Checkout_PersonInfo_InputCZ_Base
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
...
//    {
//        $format = array(
//            'layout-file'        => 'customer-info-input-config.ini'
//           ,'files' => array(
//            )
//           ,'options' => array(
//            )
...
//    }
     ...
     */
    function CheckoutCustomerInfoInput()
    {
      ...
      $this->CHECKOUT_STORE_BLOCK_NAME = "customer-info-input";
      ...
      $this->BLOCK_TAG_NAME = "CheckoutCustomerInfoInput";
