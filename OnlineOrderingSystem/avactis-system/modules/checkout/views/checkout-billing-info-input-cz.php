...
/**
 * Checkout Billing-Info-Input view.
 *
 * @package Checkout
 * @author Vadim Lyalikov
 */
class CheckoutBillingInfoInput extends Checkout_PersonInfo_InputCZ_Base
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
    ...
    {
    	$format = array(
    	    'layout-file'        => 'billing-info-input-config.ini'
    	   ,'files' => array(
