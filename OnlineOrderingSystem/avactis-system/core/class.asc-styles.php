 ...
 * @since r74
 */
class ASC_Styles extends ASC_Dependencies {
	var $base_url;
	var $content_url;
	var $default_version;
	...
	function __construct() {
		/**
		 * Fires when the ASC_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param ASC_Styles &$this ASC_Styles instance, passed by reference.
		 */
		do_action_ref_array( 'asc_default_styles', array(&$this) );
	}
