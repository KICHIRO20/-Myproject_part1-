...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('SYS','PM_PAGE_TITLE');
		$tpl_header = getxMsg('SYS','PAYM_METH_PAGE_NAME');
		...
		$tpl_parent = array(
					...
					array(
						'name' => getxmsg('SYS','PM_PAGE_TITLE'),
						'url' => ''
				));
		$tpl_help = 'store_settings_payment';
		$tpl_class = 'CheckoutPaymentModulesList';
