...
/**
 * Checkout module.
 * Action handler on SetCurrentShippingModuleSettingsViewName.
 *
 * @package Checkout
 * @access  public
 */
class SetCurrentShippingModuleSettingsViewName extends AjaxAction
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
     ...
     */
    function SetCurrentShippingModuleSettingsViewName()
    {
    }
    ...
    function onAction()
    {
        ...
        $uid = $request->getValueByKey( 'sm_uid' );

        if ($view_class_name != NULL)
        {
            modApiFunc('Checkout', 'setCurrentPaymentShippingModuleSettingsUID', $uid);
            $retval = modApiFunc('Checkout', 'setCurrentShippingModuleSettingsViewName', $view_class_name);
        }
    }
    /**#@-*/
