...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('SYS','MAIL_PAGE_TITLE');
		$tpl_header = getxMsg('SYS','MAIL_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
					...
					array(
						'name' => getxmsg('SYS','MAIL_PAGE_TITLE'),
						'url' => 'mail_settings.php'
				));
		$tpl_help = 'mail_settings';
		$tpl_class = 'MailParamList';
