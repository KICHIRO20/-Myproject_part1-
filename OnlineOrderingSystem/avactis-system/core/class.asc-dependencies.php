 ...
 *
 * Classes were refactored from the ASC_Scripts and WordPress script enqueue API.
 *
 * @since BackPress r74
 *
 * @package BackPress
 * @uses _ASC_Dependency
 * @since r74
 */
class ASC_Dependencies {
	/**
	...
	/**
	 * An array of queued _ASC_Dependency handle objects.
	 *
	 * @access public
	 * @since 2.6.8
	 * @var array
	...
	/**
	 * An array of _ASC_Dependency handle objects to queue.
	 *
	 * @access public
	 * @since 2.6.0
	 * @var array
	...
	/**
	 * An array of _ASC_Dependency handle objects already queued.
	 *
	 * @access public
	 * @since 2.6.0
	 * @var array
	...
	public function do_items( $handles = false, $group = false ) {
		...
		foreach( $this->to_do as $key => $handle ) {
			if ( !in_array($handle, $this->done, true) && isset($this->registered[$handle]) ) {
				 ...
				 *
				 * Example: The extending class ASC_Scripts is used to register 'scriptaculous' as a set of registered handles:
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _ASC_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
