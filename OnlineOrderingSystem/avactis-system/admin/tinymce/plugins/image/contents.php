	...
	foreach($latest as $c){
		if($view == 'list'){
			if($c['is_file'] == false){
				...
				<td width="10%">
					<a href="" class="transparent change-folder" title="'._lang('change_name').'" rel="'. $c['name'] .'"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
					<a href="" class="transparent delete-folder" rel="'. urlencode($c['path']).'" title="'._lang('delete').'"><i class="icon-trash"></i></a>
				</td>
				</tr>';
			}else{
				...
				if(!is_image_extenstion($extension)){
					...
					<td width="10%">
						<a href="" class="transparent change-file" title="'._lang('change_name').'" rel="'. $c['name'] .'"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
						<a href="" class="transparent delete-file" rel="'. urlencode($c['p']).'" title="'._lang('delete').'"><i class="icon-trash"></i></a>
					</td>
					</tr>';
				}else{
					$html .= '<tr>
