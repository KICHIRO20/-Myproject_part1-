 ...
 */
class CheckoutPaymentModuleGCInput
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
    ...
    {
    	$format = array(
    	    'layout-file'        => "checkout-payment-module-gc-input-config.ini" //; $this->LayoutFile
    	   ,'files' => array(
     ...
     */
    function CheckoutPaymentModuleGCInput()
    {
        global $application;
...
//------------------------------------------------
    ...
    var $BlockTemplateName = "CheckoutPaymentModuleGCInput";
    var $LayoutFile = "checkout-payment-module-gc-input-config.ini";
