...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('PF','PF_FILES_LIST_PAGE_HEADER');
		$tpl_header = getxMsg('PF','PF_FILES_LIST_PAGE_HEADER');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
				...
				array(
						'name' => getxMsg('PF','PF_FILES_LIST_PAGE_HEADER'),
						'url' => ''
				));
		$tpl_help = 'catalog_manage_products';
		$tpl_class = 'PF_FilesList';
		$tpl_tinymce = 'yes';
