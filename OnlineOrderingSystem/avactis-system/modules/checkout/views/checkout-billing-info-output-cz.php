...
/**
 * Checkout Billing-Info-Output view.
 *
 * @package Checkout
 * @author Vadim Lyalikov
 */
class CheckoutBillingInfoOutput extends Checkout_PersonInfo_OutputCZ_Base
{
//------------------------------------------------
//               PUBLIC DECLARATION
//------------------------------------------------
    ...
    {
    	$format = array(
    	    'layout-file'        => 'billing-info-output-config.ini'
    	   ,'files' => array(
     ...
     */
    function CheckoutBillingInfoOutput()
    {
      ...
      $this->CHECKOUT_STORE_BLOCK_NAME = "billing-info-output";
      ...
      $this->BLOCK_TAG_NAME = "CheckoutBillingInfoOutput";
