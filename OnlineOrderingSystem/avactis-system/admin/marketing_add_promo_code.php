...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('PROMOCODES', 'PROMO_CODE_ADD_PAGE_TITLE');
		$tpl_header = getxMsg('PROMOCODES', 'PROMO_CODE_ADD_PAGE_TITLE');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
					...
					array(
						'name' => getxmsg('PROMOCODES','PROMO_CODE_ADD_PAGE_TITLE'),
						'url' => ''
				));
		$tpl_help = 'marketing_promo_codes';
		$tpl_class = 'AddPromoCode';
