...
//		$tpl_styles = array('admin-default','admin-custom');
		$tpl_title = getxMsg('PI','PI_SETTINGS_LINK');
		$tpl_header = getxMsg('PI','PI_SETTINGS_LINK');
		$tpl_onload_js = '';
		$tpl_parent = array(
					array(
					...
					array(
						'name' => getxmsg('PI','PI_SETTINGS_LINK'),
						'url' => ''
				));
		$tpl_help = 'Product_Image_Settings';
		$tpl_class = 'PI_Settings';
