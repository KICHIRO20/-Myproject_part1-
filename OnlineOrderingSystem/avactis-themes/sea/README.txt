...
1.  Download Avactis theme package on your local computer.
    The name of the archive will be avactis.1.9.1.theme.sea.zip

2.  Unpack this archive on your local computer using your favorite
    file archiver software (e.g. WinZip or WinRar).

    After unpacking you will see the "avactis.1.9.1.theme.sea"
...
5.  Upload the "avactis.1.9.1.theme.sea" folder from your local
    computer, to the "avactis-themes" folder on your server using FTP
    client.
	
    After uploading, you should find  the "avactis.1.9.1.theme.sea"
...
7.  Find this line of the code inside the "storefront-layout.ini":
    ...
    TemplateDirectory = "avactis-themes/avactis.1.9.1.theme.sea/"
...
==============
Logotype of the theme is located in: "avactis.1.9.1.theme.sea/images/logo.png" file.
You can replace this logotype with your own.


How to change a Welcome Text
============
This text is located in the "avactis.1.9.1.theme.sea/welcome.html" file.
